...
def provider_status() -> dict:
    ...
    return {"ok": True, "provider_mode": gfs.mode, "providers": {"gfs": {**gfs.model_dump(mode="json"), "catalog": catalog["gfs_ncss_atmosphere"]}, "rtofs": {**rtofs.model_dump(mode="json"), "catalog": catalog["rtofs_ncep_ocean"]}, "chlorophyll": {**chlorophyll_status(), "catalog": catalog["chlorophyll_ocean_color"]}}}

...
class GFSNCSSProvider:
    ...
    def _live_frame(self, bbox: BBox) -> tuple[AtmosphereFieldFrame, ProviderStatus]:
        ...
        # TODO: parse NetCDF with xarray/netCDF4 once live dependencies are introduced.
        # For now the adapter verifies reachability and records the exact NCSS target while keeping output mock-shaped.
